...
use MTFI\Nic\Bundle\SecuredLoginBundle\Forms;
use Symfony\Component\Security\Core\Exception\AccessDeniedException;
use MTFI\Nic\Bundle\SecuredLoginBundle\Security\Keys\SecuredLoginKeys;
...
class PasswordController extends Controller implements AuditableControllerInterface {
    ...
    public function passwordchangeviewAction(Request $request) {
        ...
        return $this->render('NicSecuredLoginBundle:User:changePassword.html.twig', array('form' => $form->createView()));
    }
    ...
    public function passwordchangeAction(Request $request) {
        ...
        //return $this->render('NicSecuredLoginBundle:User:changePassword.html.twig', array('form' => $form->createView(), 'message' => $strMsg));
