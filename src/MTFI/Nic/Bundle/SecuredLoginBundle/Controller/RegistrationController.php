...
use MTFI\Nic\Bundle\SecuredLoginBundle\Entity\Registration;
use MTFI\Nic\Bundle\SecuredLoginBundle\Entity\User;
use MTFI\Nic\Bundle\SecuredLoginBundle\Forms\RegistrationType;
...
class RegistrationController extends Controller {
    ...
    public function indexAction() {
        return $this->render('NicSecuredLoginBundle:Registration:home.html.twig');
    }

    public function findAction() {
        $em = $this->getDoctrine()->getManager();

        $entities = $em->getRepository('NicSecuredLoginBundle:Registration')->findAll();

        return $this->render('NicSecuredLoginBundle:Registration:index.html.twig', array(
                    'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            try {
                ...
                $registrationNM = $em->find('NicSecuredLoginBundle:RegistrationNumberMaster', 1, \Doctrine\DBAL\LockMode::PESSIMISTIC_WRITE);
                /* Creating new user */
        ...
        return $this->render('NicSecuredLoginBundle:Registration:new.html.twig', array(
                    'entity' => $registration,
...
//        $em = $this->getDoctrine()->getManager();
//
//        $entity = $em->getRepository('NicSecuredLoginBundle:Registration')->find($id);
//
//        if (!$entity) {
//            throw $this->createNotFoundException('Unable to find Registration entity.');
//        }   

        return $this->render('NicSecuredLoginBundle:Registration:show.html.twig', array(
                    'name' => $name,
                    'appln_no' => $appln_no
        ));
    }
    ...
    public function editAction($id) {
        ...
        return $this->render('NicSecuredLoginBundle:Registration:edit.html.twig', array(
                    'entity' => $entity,
